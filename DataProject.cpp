...
int main() {
	...
	try {
		...
		//przydzielenie pamiêci i inicjalizacja czterech kana³ów
		...
		//zasymulowanie danych z bia³ym szumem
		...
		*quotient = *channelVector.at(0) / *channelVector.at(3);
		...
		//obliczenie Rms dla ka¿dego kana³u
